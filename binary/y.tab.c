...
# define YYTOKENTYPE
  enum yytokentype
  {
    ...
    instruccion = 258,             /* instruccion  */
    registro = 259,                /* registro  */
    numero = 260                   /* numero  */
  };
...
{
  "\"end of file\"", "error", "\"invalid token\"", "instruccion",
  "registro", "numero", "'\\n'", "$accept", "Inicio", "Comando",
...
#line 1162 "y.tab.c"
  ...
  case 4: /* Comando: instruccion parametro  */
#line 64 "yacc.y"
                      {procesarInstruccionDe1Parametro((yyvsp[-1].stringValue), (yyvsp[0].constString));}
#line 1168 "y.tab.c"
    break;

  case 5: /* Comando: instruccion parametro parametro  */
#line 65 "yacc.y"
                                  {procesarInstruccionDe2Parametros((yyvsp[-2].stringValue), (yyvsp[-1].constString), (yyvsp[0].constString));}
#line 1174 "y.tab.c"
    break;

  case 6: /* Comando: instruccion parametro parametro parametro  */
#line 66 "yacc.y"
                                            {procesarInstruccionDe3Parametros((yyvsp[-3].stringValue), (yyvsp[-2].constString), (yyvsp[-1].constString), (yyvsp[0].constString));}
#line 1180 "y.tab.c"
    break;

  case 7: /* parametro: registro  */
#line 70 "yacc.y"
            {(yyval.constString) = registroANumeroBinario((yyvsp[0].stringValue));}
#line 1186 "y.tab.c"
    break;

  case 8: /* parametro: numero  */
#line 71 "yacc.y"
            {(yyval.constString) = literalANumeroBinario((yyvsp[0].stringValue));}
#line 1192 "y.tab.c"
    break;
